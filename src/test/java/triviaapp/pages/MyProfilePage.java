...
public class MyProfilePage extends BasePage {
  ...
  public EmailPage openEmailPage(){
    emailButton.click();
    Log.info("Email button is clicked");
    return new EmailPage(driver);
  }

  public DifficultyPage openDifficultyPage(){
    difficultyButton.click();
    Log.info("Difficulty button is clicked");
    return new DifficultyPage(driver);
  }

  public SettingsPage openSettingsPage(){
    settingsButton.click();
    Log.info("Setting button is clicked");
    return new SettingsPage(driver);
  }

  public void verifyMyProfileHeader(){
    Assert.assertEquals(getHeaderText(), Texts.MY_PROFILE_HEADER);
  }
